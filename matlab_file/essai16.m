...
% essai16.m
%
% Model exported on Feb 24 2025, 13:52 by COMSOL 6.3.0.335.
...
model.label('geometry_finale_mph_capa_6.3_v4.mph');
...
model.component('comp1').geom('geom1').feature('wp1').label('Electrode_1');
model.component('comp1').geom('geom1').feature('wp1').set('quickplane', 'yz');
model.component('comp1').geom('geom1').feature('wp1').set('quickx', '-100e-6');
...
model.component('comp1').geom('geom1').feature('wp1').geom.feature('pol1').set('table', [-2.0E-5 -2.5E-5; -2.0E-5 2.5E-5; 2.0E-5 2.5E-5; 2.0E-5 -2.5E-5]);
model.component('comp1').geom('geom1').feature('wp1').geom.feature('pol1').set('selresult', true);
model.component('comp1').geom('geom1').feature('wp1').geom.feature('pol1').set('color', '15');
...
model.component('comp1').geom('geom1').feature('wp2').geom.feature('pol1').set('table', [-2.0E-5 -2.5E-5; -2.0E-5 2.5E-5; 2.0E-5 2.5E-5; 2.0E-5 -2.5E-5]);
...
model.component('comp1').physics('ec').feature('gnd1').selection.set([8]);
model.component('comp1').physics('ec').create('term1', 'Terminal', 2);
model.component('comp1').physics('ec').feature('term1').selection.set([5]);
...
model.component('comp1').view('view2').set('showmaterial', true);
model.component('comp1').view('view2').axis.set('xmin', -1.0455444862600416E-4);
model.component('comp1').view('view2').axis.set('xmax', 1.0455444862600416E-4);
model.component('comp1').view('view2').axis.set('ymin', -4.934579192195088E-5);
model.component('comp1').view('view2').axis.set('ymax', 4.934579192195088E-5);
...
model.component('comp1').material('mat2').propertyGroup('def').set('electricconductivity', {'1e-1' '0' '0' '0' '1e-1' '0' '0' '0' '1e-1'});
...
model.component('comp1').selection('sel1').set('color', '14');
...
model.component('comp1').selection('sel2').set([8]);

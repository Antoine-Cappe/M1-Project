...
% blank7.m
%
% Model exported on Feb 26 2025, 13:14 by COMSOL 6.3.0.335.
...
model.component('comp1').physics('ec').feature('term1').set('toBeCreatedElement', 'ModelDeviceIV');
model.component('comp1').physics('ec').feature('term1').runCommand('addElectricalCircuitConnection');

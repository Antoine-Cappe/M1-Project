...
% geo1t.m
%
% Model exported on Jan 30 2025, 11:42 by COMSOL 6.3.0.335.
...
model.modelPath('C:\Users\Vincent Senez\BIOCAD-2_Projet_YES');
...
model.component('comp1').geom('geom1').feature('blk1').label('BioreactorBBBBBB');

...
% essai4.m
%
% Model exported on Oct 9 2024, 17:40 by COMSOL 6.2.0.415.
...
model.result.table('tbl1').comments(['Int' native2unicode(hex2dec({'00' 'e9'}), 'unicode') 'gration sur surface 1']);
...
model.sol('sol1').feature('v1').set('clist', {'1000[Hz] 2000[Hz] 3000[Hz] 4000[Hz] 5000[Hz] 6000[Hz] 7000[Hz] 8000[Hz] 9000[Hz] 10000[Hz] 20000[Hz] 30000[Hz] 40000[Hz] 50000[Hz] 60000[Hz] 70000[Hz] 80000[Hz] 90000[Hz] 100000[Hz] 200000[Hz] 300000[Hz] 400000[Hz] 500000[Hz] 600000[Hz] 700000[Hz] 800000[Hz] 900000[Hz]'});
...
model.result.numerical('int1').set('descr', {['Densit' native2unicode(hex2dec({'00' 'e9'}), 'unicode') ' de courant, norme']});
...
model.result('pg2').label(['Norme du champ ' native2unicode(hex2dec({'00' 'e9'}), 'unicode') 'lectrique (ec)']);
...
model.result('pg2').feature('strmsl1').set('descr', ['Champ ' native2unicode(hex2dec({'00' 'e9'}), 'unicode') 'lectrique']);
...
model.result('pg3').feature('glob1').set('expr', {'abs(1/ec.Y11)'});
model.result('pg3').feature('glob1').set('unit', {['ohm' ]});

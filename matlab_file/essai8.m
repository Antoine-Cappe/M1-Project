...
% essai8.m
%
% Model exported on Feb 7 2025, 11:44 by COMSOL 6.3.0.335.
...
model.component('comp1').geom('geom1').feature('blk1').set('selresultshow', 'dom');
model.component('comp1').geom('geom1').feature('blk1').set('color', '2');
model.component('comp1').geom('geom1').feature('blk2').set('selresult', true);
model.component('comp1').geom('geom1').feature('blk2').set('color', '6');
model.component('comp1').geom('geom1').feature('blk3').set('selresult', true);
model.component('comp1').geom('geom1').feature('blk3').set('color', '10');
...
model.label('geometry_finale_mph_capa_6.3.mph');

model.component('comp1').geom('geom1').feature('blk1').setIndex('size', '100e-6', 0);
model.component('comp1').geom('geom1').run('blk1');
model.component('comp1').geom('geom1').feature('blk1').set('pos', [-50 0 0]);
model.component('comp1').geom('geom1').run('blk1');
model.component('comp1').geom('geom1').run('fin');
model.component('comp1').geom('geom1').feature('blk1').set('pos', {'-50e-6' '0' '0'});
model.component('comp1').geom('geom1').run;
model.component('comp1').geom('geom1').run('fin');
model.component('comp1').geom('geom1').feature.duplicate('blk4', 'blk1');
model.component('comp1').geom('geom1').feature.move('blk4', 1);
model.component('comp1').geom('geom1').feature('blk4').set('pos', {'+50e-6' '0' '0'});
model.component('comp1').geom('geom1').run('fin');
model.component('comp1').geom('geom1').feature('blk4').label('Bioreactou');
model.component('comp1').geom('geom1').run('wp2');
model.component('comp1').geom('geom1').create('uni1', 'Union');
model.component('comp1').geom('geom1').feature('uni1').selection('input').set({'blk1' 'blk4'});
model.component('comp1').geom('geom1').feature('uni1').label('Bioreactore');
model.component('comp1').geom('geom1').feature('blk1').label('Bioreactor1');
model.component('comp1').geom('geom1').feature('blk4').label('Bioreactor2');
model.component('comp1').geom('geom1').feature('uni1').label('Bioreactor');

model.label('geometry_finale_mph_capa_6.3bis.mph');
...
model.component('comp1').geom('geom1').feature('uni1').set('color', '13');
...
model.component('comp1').geom('geom1').feature('blk4').setIndex('size', '90e-6', 0);
model.component('comp1').geom('geom1').run('fin');
...
model.result('pg3').run;
model.result('pg3').run;
model.result('pg3').feature.remove('iso1');
model.result('pg3').run;
model.result('pg3').run;
model.result('pg3').feature('str1').set('data', 'dset1');
model.result('pg3').run;
model.result('pg3').feature('str1').setIndex('looplevel', 24, 0);
model.result('pg3').run;
model.result('pg3').run;
model.result('pg1').run;
model.result('pg3').run;
...
model.result('pg3').run;
model.result('pg3').feature('con1').set('expr', 'ec.normE');
model.result('pg3').feature('con1').set('descr', 'Electric field norm');
model.result('pg3').run;
model.result('pg3').run;
model.result('pg3').feature.remove('str1');
model.result('pg3').run;
model.result('pg3').run;
model.result('pg3').feature('con1').set('data', 'dset1');
model.result('pg3').run;
model.result('pg3').feature('con1').setIndex('looplevel', 21, 0);
model.result('pg3').run;
...
model.component('comp1').physics('cir').feature('V1').set('value', '25[mV]');
...
model.component('comp1').physics('cir').feature('R1').set('R', ['50e-5[' 'ohm' ']']);
...
model.component('comp1').physics('cir').feature('R2').set('R', ['1000000000[' 'ohm' ']']);
...
model.component('comp1').physics('cir').feature('C1').setIndex('Connections', 2, 1, 0);
...
model.result('pg3').run;
model.result.numerical('gev2').set('expr', {'cir.freq'});
...
model.result('pg3').feature('lngr1').set('xdataexpr', 'cir.freq');
model.result('pg3').feature('lngr1').set('descr', ' Current through device R1');
model.result('pg3').feature('lngr1').set('expr', 'cir.v_1/cir.R1.i');
model.result('pg3').run;
model.result('pg3').feature('lngr1').set('data', 'dset1');
model.result('pg3').run;
model.result('pg3').run;

model.study('std1').feature('freq').setSolveFor('/physics/cir', false);

...
% essai2.m
%
% Model exported on Oct 9 2024, 17:10 by COMSOL 6.2.0.415.
...
model.sol('sol1').feature('s1').feature('pDef').label(['Param' native2unicode(hex2dec({'00' 'e9'}), 'unicode') 'trique 2']);
model.sol('sol1').feature('s1').feature('pDef').set('pname', {'freq'});
model.sol('sol1').feature('s1').feature('pDef').set('plistarr', {'1000 2000 3000 4000 5000 6000 7000 8000 9000 10000 20000 30000'});
...
model.result('pg1').set('xmin', 923.4124820842267);
model.result('pg1').set('xmax', 32488.18981988124);
model.result('pg1').set('ymin', 100);
model.result('pg1').set('ymax', 20000.000000000004);
model.result('pg1').set('xlog', true);
model.result('pg1').set('ylog', true);
model.result('pg1').set('xlabelactive', false);
model.result('pg1').feature('glob1').set('expr', {'abs(1/ec.Y11)'});
model.result('pg1').feature('glob1').set('unit', {['ohm' ]});
...
model.result('pg2').set('looplevel', [27]);

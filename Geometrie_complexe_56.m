function out = model
%
% Geometrie_complexe_56.m
%
% Model exported on Jan 10 2025, 10:49 by COMSOL 5.6.0.401.
...
model.component('comp1').geom('geom1').feature('wp1').active(true);
model.component('comp1').geom('geom1').feature('wp2').active(true);
model.component('comp1').geom('geom1').run;

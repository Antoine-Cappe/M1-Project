function [tlm,model]=SetDomainValues(tlm,model)
    ...
    global fem_mesh_t; % Domaines des tétraèdres 

    fprintf('\n\t . Recherche des indices du maillage (Sélections actives)...');
    ...
    tlm.ind.pt.elec2    = find_node(coord_pt1); % Point sur l'électrode 2
    tlm.ind.pt.elec1    = find_node(coord_pt2); % Point sur l'électrode 1
    tlm.ind.pt.MilOrga  = find_node(coord_pt3); % Point dans le milieu organique

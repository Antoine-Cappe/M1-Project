...
%
%   Routine InitParam1 called by Biocad,
%
%   Function: Initialize Geometrical & Physical Parameters for 1 cell
%             configuration
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function tlm=IniParaOneNonSphere(tlm)

% Directories Configuration

tlm.conf.src='C:\Documents and Settings\Vincent Senez\Mes documents\simulation\Biocad_2.1\src';
tlm.conf.result='C:\Documents and Settings\Vincent Senez\Mes documents\simulation\Biocad_2.1\result\nonsphere';
...
% Configuration of the Bio-Physical System
    ...
    tlm.conf.Shape=1;                   % 0 spheroid cell, 1 non_spheroid cell, 2 arbitrary shaped cell

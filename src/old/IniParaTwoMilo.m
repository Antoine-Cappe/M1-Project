...
%
%   Routine IniParaTwoMilo called by Biocad,
%
...
function tlm=IniParaTwoMilo(tlm)
...
if tlm.conf.dim==2
    ...
    tlm.var.Center=25e-6;              % Shift for the two mediums' center
    ...
    tlm.var.LargeurChambre=50e-6;      % Width of the chamber
...
elseif tlm.conf.dim==3
    ...
    tlm.var.Center=2.5e-6;              % Shift for the two mediums' center
    ...
    tlm.var.LongueurChambre=10e-6;     % Length of the chamber
    tlm.var.LargeurChambre=5e-6;      % Width of the chamber
    %tlm.var.LargeurChambre=10e-6;      % Width of the chamber
    tlm.var.EpaisseurChambre=10e-6;    % Thickness of the chamber
...
if tlm.conf.points==2
    tlm.conf.result=[tlm.conf.result '\twomilo\2points\' tlm.conf.Name];
elseif tlm.conf.points==4
    tlm.conf.result=[tlm.conf.result '\twomilo\4points\' tlm.conf.Name];
end

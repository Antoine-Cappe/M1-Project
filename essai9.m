...
% essai9.m
%
% Model exported on Feb 7 2025, 14:43 by COMSOL 5.6.0.341.
...
model.component('comp1').geom('geom1').feature('pt3').setIndex('p', '0.000095', 0);
model.component('comp1').geom('geom1').run;

model.param.set('sig1', '1e6');

model.component('comp1').material('mat1').propertyGroup('def').set('electricconductivity', {'sig1'});

model.param.set('eps1', '80');

model.component('comp1').material('mat1').propertyGroup('def').set('relpermittivity', {'eps1'});
